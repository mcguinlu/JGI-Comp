...
### Code availability
**Note:** All code used within this section is available for review. You can view the code by clicking the "Code"" button on the right hand side of the screen within a specific section. For example:
...
There was no evidence that outward migration for education at either the county or regional level had any effect on the mean loneliness score in the county or region. Similarly, there was no evidence for a relationship between total population change (sum of students moving into and out of a region) due to migration for education.
...
By mapping the loneliness score of the region in England to the student Higher Education provider location, training sets are created. They contain the longitude and latitude of the student, the distance (km) between the domicile and the H.E. provider and a binary representation of the loneliness z-score.
